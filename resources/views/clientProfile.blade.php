    ...
    <div class="col-md-8 col-lg-6 d-flex justify-content-center rounded-5 bg-light p-5 shadow-lg">
      ...
      <form method="POST" action="{{ route('clientProfile.updateProfile') }}" class="w-100">
        ...
        <div class="form-group mt-4">
          <label class="form-label my-1 ">Nombre y apellido actual:</label>
        ...
        <div class="form-group mt-4">
          <label class="form-label my-1 pt-3">E-mail actual:</label>
        ...
        <div class="form-group mt-4 ">
          <label class="form-label my-1 pt-3">Teléfono actual:</label>
        ...
        <div class="form-group mt-4">
          <label class="form-label my-1 pt-3">Dirección actual:</label>
        ...
        <div class="d-grid gap-2 col-6 mx-auto mt-5">
          ...
          <button class="btn btn-limit botones_clientes rounded-4 mt-2 btn btn-limit botones_clientes " type="button"><a href="{{ route('passwordChange') }}" class="text-reset">Cambiar Contraseña</a>
        </div>
